var historial = (function () {
    $(document).ready(function () {
        var table = $('#tableHistorial').DataTable({
            ...
            "ajax": resolveUrl("~/Alisto/ListHistorial"),
            "columns": [
                {
                    "orderable": false,
                    "data": "pedido",
...
$(document).ready(function () {
    $("#bntFilter").on('click', function () {
        if ($("#fechaInicio").val() === "" || $("#fechaFin").val() === "") {
            Swal.fire({
                icon: 'info',
                title: 'Upps..',
                html: 'Debe de seleccinar fechas para poder realizar el filtro'
            });
        }
            ...
            Swal.fire({
                icon: 'info',
                title: 'Upps..',
                html: 'La fecha de inicio es más reciente que la fecha final'
            });
        }
            ...
            Swal.fire({
                icon: 'info',
                title: 'Upps..',
                html: 'Debes de seleccionar un estado para poder realizar la busqueda'
            });
        }
        else {
            ...
            var table = $('#tableHistorial').DataTable({
                ...
                "ajax": resolveUrl("~/Alisto/ListHistorialFilter?fechaInicio=" + $("#fechaInicio").val() +
                    "&fechaFinal=" + $("#fechaFin").val() +
                    "&estado=" + $("#status :selected").val()),
                "columns": [
                    {
                        "orderable": false,
                        "data": "pedido",
