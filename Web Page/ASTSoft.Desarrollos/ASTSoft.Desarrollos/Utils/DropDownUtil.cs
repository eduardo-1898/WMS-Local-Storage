...
namespace ASTSoft.Desarrollos.Utils
{
    ...
    {
        public static List<SelectListItem> GetDropDownPappingGeneric<T>(IList<T> data, string key, string value, List<Guid> keySelected = null)
        {
            ...
            {
                var view = item;
                var itemKey = (Guid)(view.GetType().GetProperty(key).GetValue(view, null));
        ...
        public static List<SelectListItem> GetDropDownPappingGeneric<T>(IList<T> data, string key, string value, Guid? keySelected = null)
        {
            return GetDropDownPappingGeneric(data, key, value, new List<Guid> { keySelected == null ? Guid.Empty : keySelected.Value });
        }

        public static List<SelectListItem> GetDropDownPappingGeneric<T>(IList<T> data, string key, string value)
        {
            return GetDropDownPappingGeneric(data, key, value, new List<Guid> { Guid.Empty });
        }
        ...
        public static MultiSelectList GetDropDownMultiplePappingGeneric<T>(List<T> data, string key, string value, List<Guid> keySelected = null)
        {
